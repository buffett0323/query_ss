...
class EffectMixin:
    ...
    def seq_perturb_reverse(
        self,
        num_segments: typing.Union[torch.Tensor, np.ndarray, int] = 5,
        fixed_second: typing.Union[torch.Tensor, np.ndarray, float] = 0.3,
        reverse_prob: typing.Union[torch.Tensor, np.ndarray, float] = 0.5,
    ):
        ...
        Parameters
        ----------
        num_segments : typing.Union[torch.Tensor, np.ndarray, int], optional
            Number of segments to divide the back portion into, by default 5
        fixed_second : typing.Union[torch.Tensor, np.ndarray, float], optional
            Duration in seconds for the front segment that remains untouched,
            by default 0.3
        reverse_prob : typing.Union[torch.Tensor, np.ndarray, float], optional
            Probability of reversing each individual segment, by default 0.5
