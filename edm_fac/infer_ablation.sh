python infer_adsr_short2long.py \
    --checkpoint /home/buffett/nas_data/EDM_FAC_LOG/0719_mn_ablation_v2/ckpt/checkpoint_latest.pt \
    ...
    --output_dir 0720_exp_ablation_short2long/ \
    --convert_type both \
    --device cuda:2 \
    --prefix "both_"
...
python infer_adsr_short2long.py \
    ...
    --output_dir 0720_exp_ablation_long2short/ \
    --convert_type both \
    --device cuda:2 \
    --prefix "both_"
