...
parser.add_argument('-b', '--batch-size', default=128,#512, 
                    type=int, metavar='N',
...
parser.add_argument('--need-clar-transform', default=True, type=bool)
parser.add_argument('--window-size', default=1024, type=int)
parser.add_argument('--hop-length', default=320, type=int)
parser.add_argument('--n-mels', default=128, type=int)
parser.add_argument('--fmin', default=20, type=int)
...
parser.add_argument('--drop-last', default=True, type=bool)
